        ...
        <Row className="align-items-center">
          ...
          <Col size={12} sm={6} className="text-center text-sm-end">
            <div className="social-icon">
              <a
                href="https://www.linkedin.com/in/sudesh-kavinda-1a5909270/"
                target="_blank"
              ...
              <a
                href="https://github.com/sudeshkavinda550"
                target="_blank"
                rel="noopener noreferrer"
              >
                <svg
                ...
                >
                  ...
                  11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-.842-.575.063-.562.063-.562 
                  1.205.084 1.839 1.237 
                  1.839 1.237 1.07 1.834 
              ...
              <a href="mailto:sudeshkavinda550@gmail.com">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"

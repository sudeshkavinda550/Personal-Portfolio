...
import headerImg from "../assets/img/Generated_Image_September_09__2025_-_8_37AM-removebg-preview.png";
            ...
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{`Hi! I'm Sudesh`} <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "Fullstack Developer", "Web Designer", "UI/UX Designer" ]'><span className="wrap">{text}</span></span></h1>
                  <p>I am a very motivated and adaptive person with a great knack for
...
and approach problems pro-actively and solution-focused. I'm
keen to keep learning new things so that I can contribute
